...
def rightBoard():
    ...
    for box in range(0,11):
        if(box == 10):
            ...
            boxLabel = Label(gameWindow, font=("Helvetica",55), width=8, height=1, relief='ridge', borderwidth=0, bg="white")
            boxLabel.place(x=xPos, y=screen_height/2 - 100)
            rightBoxes.append(boxLabel)
            xPos +=50
...
def askPlayerName():
    ...
    button = Button(nameWindow, text="Save", font=("Chalkboard SE", 30),width=15, command=saveName, height=1, bg="#80deea", bd=3)
